...
public class AccountDAO {
    ...
    //nu am facut metoda de insert deoarece introduc account-ul din client
    ...
    /*userul care este logat isi updateaza propria parola
    public int updatePassoword(String password, String username) {
