...
public class PurchaseController {
    ...
    //ofer acces la endpoint-ul de mai jos doar user-ului logat in aplicatie
    ...
    //ofer acces la endpoint-ul de mai jos doar user-ului cu rol de administrator logat in aplicatie
